      ...
      {isOpenMenu && (
        <div className='h-0 w-0 relative'>
          ...
          <div className='top-0 right-40px z-1 absolute sm:top-0 '>
            <div className='bg-primary-light border border-primary cursor-pointer rounded-10px shadow-lg shadow-primary-light transform w-170px overflow-hidden sm:w-150px'>
              {user?.id === post.userId && (
                <>
                  <button
