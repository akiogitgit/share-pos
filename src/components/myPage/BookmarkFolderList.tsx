...
export const BookmarkFolderList: FC<Props> = ({
  ...
  return (
    <>
      ...
      <div className='flex h-50px mt-5 gap-2 overflow-x-scroll scroll-bar sm:(flex-col h-auto min-w-190px max-w-190px max-h-78vh overflow-x-hidden overflow-y-scroll) '>
